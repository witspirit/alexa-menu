...
/**
 * Experimentation utility for the ApiGwMenuDao
 *
...
public class ApiGwMenuDaoExperimenter {
    ...
    private ApiGwMenuDao menuStore;

    @BeforeEach
    void initMenuStore() {
        this.menuStore = new ApiGwMenuDao(DEV).withAccessToken(ACCESS_TOKEN);
    }
