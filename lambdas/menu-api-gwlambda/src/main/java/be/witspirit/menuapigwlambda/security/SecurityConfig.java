...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public void configure(WebSecurity web) throws Exception {
        // The skill is authenticated using a signature based Alexa means. And our test endpoints are handy when unauthenticated
        web.ignoring().antMatchers("/chefskill/**", "/test/**");
    }
